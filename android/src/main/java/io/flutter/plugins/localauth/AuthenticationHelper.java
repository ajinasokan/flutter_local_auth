...
class AuthenticationHelper extends FingerprintManagerCompat.AuthenticationCallback
  ...
  private final FingerprintManagerPolyfill fingerprintManager;
  ...
  AuthenticationHelper(
    ...
    this.fingerprintManager = new FingerprintManagerPolyfill(activity);
  }
  ...
  private void resume() {
    ...
    fingerprintManager.authenticate(0, cancellationSignal, this);
  }
